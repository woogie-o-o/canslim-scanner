...
class QuantNexusApp:
    ...
    KR_NAMES: dict[str, str] = {
        ...
        "031430.KS": "신세계인터내셔날",    # 패션·화장품·면세 유통
        "080160.KS": "모두투어",            # 여행패키지
        "104620.KS": "노랑풍선",            # 여행패키지
        "084680.KS": "이월드",              # 테마파크·리테일
        "091810.KS": "티웨이항공",          # 저비용항공LCC
        "094840.KQ": "슈프리마",            # 생체인식·출입통제
        "236200.KQ": "슈프리마아이디",      # 모바일ID·생체인증
        "054800.KQ": "아이디스홀딩스",      # 영상보안 지주
        "143160.KQ": "아이디스",            # CCTV·영상보안
        "047560.KQ": "이스트소프트",        # AI보안·알약
        "208350.KQ": "지란지교시큐리티",    # 메일·문서보안
        "054920.KQ": "한컴위드",            # 전자서명·인증보안
        "010620.KS": "HD현대미포",          # 중형선박·LPG선
        "037620.KQ": "미래에셋벤처투자",    # 벤처투자(방산우주 노출)
        # ── 핀테크·금융데이터 ─────────────────────────────────────────────
        "064850.KQ": "에프앤가이드",        # 금융데이터·지수산출
        "053580.KQ": "웹케시그룹",          # B2B 금융SaaS(경리나라)
        # ── 신재생 KDR ──────────────────────────────────────────────────────
        "950140.KS": "징코솔라",            # 태양광 KDR
    }
    ...
    KR_DESC: dict[str, str] = {
        ...
        "178930.KQ": "반도체소모품·부품", "009770.KS": "플랜트엔지니어링",
        ...
        "059090.KQ": "반도체 공정용 세라믹 히터·MLCC 부품",
        # 로봇 추가
        ...
        "439090.KQ": "비건뷰티",
        # ── 핀테크·금융데이터 ─────────────────────────────────────────────
        "064850.KQ": "금융데이터·지수산출", "053580.KQ": "B2B금융SaaS",
        # ── 2026-06 누락 보강: kr_sectors에 있으나 KR_DESC 미수록 ───
        "000390.KS": "건축·공업용도료", "000400.KS": "손해보험",
        "001680.KS": "식품·발효조미소재", "002900.KS": "농기계·트랙터",
        "003960.KS": "참치·식품가공", "004960.KS": "종합건설시공",
        "007210.KS": "건자재·유리면보온", "009290.KS": "비타500·한방음료제약",
        "014790.KS": "건설시공", "017810.KS": "두부·면류·식품",
        "020000.KS": "프리미엄패션브랜드", "025750.KS": "바닥재·인테리어건자재",
        "035890.KQ": "주택건설·시행", "041920.KQ": "환자모니터·의료기기",
        "045970.KQ": "반도체설계ASIC", "053350.KQ": "정보보안·전자금융",
        "058970.KS": "SCM·구매솔루션SW", "067000.KQ": "PC·모바일게임",
        "075180.KS": "자동차시트부품", "090350.KS": "건축·산업용도료",
        "091700.KQ": "카메라모듈·RF센서", "093050.KS": "패션·헤지스·LF몰",
        "099750.KQ": "병원EMR·의료IT", "108670.KS": "창호·바닥재·자동차소재",
        "131090.KQ": "보안접근제어SW", "183190.KS": "시멘트·레미콘",
        "194700.KQ": "건강기능식품ODM", "200130.KQ": "건강기능식품OEM",
        "249420.KS": "소화기·호흡기제약", "282880.KQ": "2차전지조립장비",
        "300720.KS": "시멘트·건자재", "322310.KQ": "전자부품유통",
        "950170.KQ": "여행·관광서비스KDR",
    }
    ...
    US_NAMES: dict[str, str] = {
        ...
        "GRRR": "고릴라 테크놀로지",
        # ── 2026-05 추가: 양자컴퓨팅·로봇·드론·방산·EV충전·중국ADR·바이오 ───
        "ARQQ": "아르킷 퀀텀",
        "AVAV": "에어로바이런먼트",
        "BILI": "빌리빌리",
        "BKSY": "블랙스카이 테크놀로지",
    ...
    US_DESC: dict[str, str] = {
        ...
        "PL":   "초소형 위성 군집 · 지구 관측",
        # ── 2026-05 추가: 양자·로봇·드론·방산·EV충전·중국ADR·바이오 ───
        "ARQQ": "양자암호 · 양자보안 플랫폼",
        "AVAV": "전술 드론 · 스위치블레이드",
        "BILI": "중국 동영상 · 게임 플랫폼",
        "BKSY": "위성 지구관측 · 지리공간 인텔",
        "BLNK": "EV 충전 네트워크",
        "CART": "온라인 식료품 배달 플랫폼",
        "CHPT": "EV 충전 인프라 1위",
        "DNA":  "합성 생물학 · 바이오 파운드리",
        ...
        "MSFT": "애저 · 오피스365 · 코파일럿",
        "MU":   "DRAM · 낸드 · HBM 메모리",
        "NET":  "CDN · DDoS 보호 · 웹 보안",
        "NKE":  "세계 최대 스포츠 의류 · 운동화",
        "NOC":  "B-21 폭격기 · 위성 · 방산",
        "NOW":  "IT 워크플로 · AI 자동화",
        "NVO":  "위고비 · 오젬픽 · GLP-1",
        "PANW": "차세대 방화벽 · SASE",
        ...
        "RTX":  "미사일 · 레이더 · 항공엔진",
        "SLB":  "세계 최대 유전 서비스",
        "SMCI": "AI 서버 · GPU 서버 조립",
        "SQM":  "칠레 리튬 · 요오드 · 비료",
        "TERN": "NASH · 비만 치료제 바이오",
        "VRT":  "데이터센터 냉각 · 전력 인프라",
        "VZ":   "미국 최대 무선통신사",
        "WDAY": "HR · ERP · 클라우드 SaaS",
        "WMT":  "세계 최대 소매 유통",
        "XYZ":  "스퀘어 POS · 캐시앱",
        "ZS":   "제로트러스트 · 클라우드 보안",
        # ── 2026-06 추가: US_DESC 전면 보강 ────────────────────────
        "ABCB": "지역 상업은행 · 미국 남동부",
        "ACA": "건설자재 · 경량집성재 · 인프라",
        "ACAD": "CNS 신약 · 레트 증후군",
        "ACI": "미국 2위 슈퍼마켓 체인",
        "ACMR": "반도체 세정장비 · EUV 공정",
        "ADMA": "혈장 파생 면역글로불린",
        "ADNT": "자동차 시트 · 인테리어 부품",
        "AFG": "특수보험 · 연금 · 리스크",
        "AGCO": "농기계 · 트랙터 · FENDT",
        "AGIO": "혈액암 · 대사질환 신약",
        "AGRO": "남미 농업 · 곡물 · 에탄올",
        "AGYS": "호텔 IT · 카지노 관리 시스템",
        "AIR": "항공 MRO · 부품 유통",
        "AIT": "산업용 부품 · 유체 동력 유통",
        "ALGM": "자동차용 반도체 · 자기 센서",
        "ALKS": "중추신경계 신약 · 알코올 의존성",
        "ALV": "자동차 에어백 · 안전벨트",
        "AM": "천연가스 집하 · 미드스트림",
        "AMBP": "알루미늄 패키징 · 식음료캔",
        "AMN": "의료 인력 파견 · 임시 간호사",
        "AMR": "야금용 석탄 · 코크스용 광산",
        "AMRC": "에너지 효율 솔루션 · 청정에너지",
        "AMWL": "원격진료 · 디지털 헬스",
        "ANDE": "곡물 처리 · 비료 · 철도 수송",
        "ANGI": "홈서비스 중개 · 집수리 플랫폼",
        "AOSL": "파워 반도체 · 전력 관리 IC",
        "APG": "시설 안전 솔루션 · 소방",
        "APGE": "희귀질환 · 자가면역 항체",
        "APLE": "호텔 리츠 · 비즈니스 여행",
        "APPF": "부동산 관리 SaaS · 임대 플랫폼",
        "APPN": "로우코드 자동화 · BPM 플랫폼",
        "ARCB": "LTL 화물 · 트럭 운송",
        "ARCO": "맥도날드 남미 프랜차이즈",
        "AROC": "가스 압축 서비스 · 미드스트림",
        "ASAN": "협업 워크 매니지먼트 SaaS",
        "ASB": "지역 상업은행 · 중서부",
        "ASGN": "IT 파견 · 전문 인력 솔루션",
        "ATHM": "중국 자동차 정보 플랫폼",
        "ATI": "항공우주용 특수합금 · 티타늄",
        "ATKR": "전선관 · 전기 인프라",
        "AVA": "태평양 북서부 전력 · 유틸리티",
        ...
        "BANF": "오클라호마 지역 상업은행",
        "BANR": "태평양 북서부 지역 은행",
        "BATRA": "애틀랜타 브레이브스 MLB 구단",
        "BATRK": "애틀랜타 브레이브스 추적주",
        "BATT": "리튬·배터리 ETF · 전기차 소재",
        "BCPC": "특수화학 · 연료첨가제",
        "BEKE": "중국 부동산 플랫폼 · 주택 거래",
        "BEP": "브룩필드 재생에너지 · 글로벌 수력·풍력",
        "BETZ": "스포츠 베팅 테마 ETF",
        "BF-B": "잭다니엘 위스키 · 프리미엄 주류",
        "BHVN": "편두통 · CNS 신약",
        "BJRI": "풀서비스 레스토랑 체인",
        "BKH": "중부 평원 전력·가스 유틸리티",
        "BKU": "플로리다 지역 상업은행",
        "BL": "회계 자동화 SaaS · 클로즈 프로세스",
        "BLD": "주택 단열재 · 건축 마감재 설치",
        "BLDR": "주택 건자재 유통 · 목재 가공",
        "BMBL": "여성 우선 데이팅 앱",
        "BMI": "수도계량기 · 스마트 유틸리티",
        "BOH": "하와이 지역 상업은행",
        "BOOM": "유정 완결 · 드릴링 소모품",
        "BOOT": "부츠 전문 소매 · 카우보이 패션",
        "BPOP": "푸에르토리코 최대 은행",
        "BRKR": "질량분석기 · 과학분석 장비",
        "BRT": "아파트 리츠 · 선벨트 주거",
        "BRX": "커뮤니티 쇼핑센터 리츠",
        "BRZE": "고객 참여 자동화 · 마케팅 SaaS",
        "BSY": "인프라 엔지니어링 BIM 소프트웨어",
        "BTG": "국제 금 채굴 · 서아프리카",
        "BTU": "야금·발전용 석탄 채굴",
        "BWA": "자동차 파워트레인 부품 · 터보차저",
        "BXSL": "블랙스톤 BDC · 선순위 대출",
        "BZH": "미국 중형 주택 건설",
        "CAKE": "캐주얼 다이닝 · 치즈케이크",
        "CALM": "계란 생산 1위 · 가금류",
        "CARG": "중고차 검색 플랫폼 · 딜러 SaaS",
        "CATY": "중화계 미국 상업은행",
        "CBSH": "미국 중서부 지역 상업은행",
        "CBT": "특수 카본블랙 · 기능성 화학",
        "CBU": "뉴욕주 지역 커뮤니티 은행",
        "CCOI": "기업용 인터넷 · 광섬유 백홀",
        "CCRN": "임시 간호사 파견 · 의료 스태핑",
        "CCS": "중형 주택 건설 · 선벨트",
        "CDE": "은·금 채굴 · 미국 알래스카",
        "CENTA": "정원·반려동물 소비재",
        "CENX": "알루미늄 제련 · 북미",
        "CFR": "텍사스 지역 상업은행 · 프라이빗뱅킹",
        "CHCT": "의료시설 넷리스 리츠",
        "CHDN": "처칠다운스 경마장 · 카지노",
        "CHE": "호스피스·가정간호 서비스",
        "CHEF": "고급 식재료 유통 · 식당 공급",
        "CHRD": "버켄 분지 석유 E&P",
        "CLB": "유전 코어 분석 · 저류층 진단",
        "CLFD": "파이버 커넥티비티 · 광섬유 부품",
        "CLNE": "CNG·LNG 연료 충전 인프라",
        "CMBM": "기업용 무선 네트워크 장비",
        "CMP": "황산칼륨 비료 · 제설염",
        "CNM": "수도관·배관 유통 · 인프라",
        "COLB": "태평양 북서부 지역 상업은행",
        "COLD": "냉동 물류창고 리츠",
        "CORT": "쿠싱 증후군 치료제 · 코티솔",
        "COUR": "온라인 교육 플랫폼 · MOOC",
        "CR": "산업용 유체 제어 · 밸브",
        "CRL": "전임상 CRO · 동물모델",
        "CRS": "항공우주용 특수 스테인리스·합금",
        "CSAN": "브라질 농업 · 사탕수수 에탄올",
        "CSIQ": "태양광 패널 · 캐나다 제조",
        "CSL": "다각화 산업재 · 냉동용기 단열",
        "CSR": "다코타 지역 아파트 리츠",
        "CSTM": "알루미늄 압출·롤드 제품",
        "CSWC": "중소기업 BDC · 선순위 대출",
        "CTRE": "고령자 의료시설 넷리스 리츠",
        "CUBE": "자가 창고 리츠 · 도심 셀프스토리지",
        "CUZ": "선벨트 오피스 리츠",
        "CVBF": "캘리포니아 지역 상업은행",
        "CWAN": "투자 운용사용 데이터 분석 SaaS",
        "CWH": "캠핑카·RV 딜러 및 캠핑용품",
        "CWT": "캘리포니아 수도 유틸리티",
        "DAR": "렌더링 · 지속가능 항공유",
        "DBI": "DSW 슈즈 · 신발 소매",
        "DBX": "클라우드 파일 공유 · 협업",
        ...
        "DCO": "항공우주 구조물 · 방산 부품",
        "DCOM": "뉴욕 지역 상업은행",
        "DECK": "UGG 부츠 · HOKA 러닝화",
        "DEI": "LA 오피스·아파트 리츠",
        "DFH": "미국 남동부 주택 건설",
        "DGII": "IoT 연결 솔루션 · 산업용 라우터",
        "DIDIY": "중국 최대 차량 공유 플랫폼",
        "DIN": "애플비스·IHOP 프랜차이즈",
        "DKL": "연료 도매 물류 · 파이프라인",
        "DLO": "신흥국 결제 · 크로스보더 핀테크",
        "DNOW": "유전 파이프·밸브 유통",
        "DOLE": "신선과일·채소 글로벌 유통",
        "DOMO": "비즈니스 BI 대시보드 · 데이터 시각화",
        "DQ": "고순도 폴리실리콘 · 태양광",
        "DRD": "남아프리카 금 채굴",
        "DSGX": "글로벌 무역 물류 소프트웨어",
        "DSP": "프로그래매틱 광고 · DSP",
        "DT": "클라우드 옵저버빌리티 · APM",
        "DTM": "천연가스 파이프라인 · 미드스트림",
        "DXC": "IT 아웃소싱 · 기업 디지털 전환",
        "EAF": "전극봉 · 전기로 소재",
        "EAT": "칠리스 레스토랑 체인",
        "EBC": "매사추세츠 지역 상업은행",
        "ECVT": "특수 화학 재활용 · 폐기물",
        "EDU": "중국 K12 교육 · 학원",
        "EFSC": "미주리 지역 상업은행",
        "EGHT": "UCaaS 클라우드 통신 · 컨택센터",
        "EGO": "그리스·캐나다 금 채굴",
        "EGP": "선벨트 산업용 리츠",
        "ELAN": "반려동물 의약품 · 동물 건강",
        "ELME": "워싱턴DC 아파트 리츠",
        "ENS": "산업용 배터리 · 데이터센터 UPS",
        "EPC": "면도기·생리대 소비재",
        "EPRT": "단일 임차인 넷리스 리츠",
        "ESAB": "용접 장비·소모품 · 가스 제어",
        "ESTA": "유방 성형 임플란트 · 의료기기",
        "EU": "우라늄 채굴 · 원자력 연료",
        "EVH": "메디케이드 관리 의료 · 보험",
        "EVTC": "카리브해 결제 처리 · 핀테크",
        "EXPD": "국제 화물 운송 주선 · 3PL",
        "FAF": "부동산 소유권 보험 · 에스크로",
        "FBIN": "욕실·보안 제품 · Fortune Brands",
        "FCF": "펜실베이니아 지역 상업은행",
        "FCPT": "레스토랑 부동산 넷리스 리츠",
        "FDP": "프레시 델몬테 신선식품 유통",
        "FFIN": "텍사스 지역 상업은행",
        "FHB": "하와이 지역 상업은행",
        "FHN": "테네시 지역 상업은행",
        "FIGS": "의료진용 스크럽 패션",
        "FIZZ": "라크루아 스파클링워터 음료",
        "FLUT": "FanDuel 스포츠 베팅 · 아일랜드",
        "FLUX": "산업용 리튬 배터리 팩 · 지게차",
        "FLYW": "교육·의료 결제 SaaS",
        "FNB": "피츠버그 기반 지역 상업은행",
        "FNF": "부동산 소유권 보험 1위",
        "FOXF": "자전거·오프로드 서스펜션",
        "FROG": "DevOps 플랫폼 · 소프트웨어 공급망",
        "FRPT": "신선·자연 반려동물 사료",
        "FRSH": "고객지원·IT서비스 SaaS",
        "FSK": "FS KKR BDC · 사모 중소기업 대출",
        "FSLY": "엣지 클라우드 CDN · API 게이트웨이",
        "FSS": "소방차·환경 특수차량",
        "FTI": "해저 유전 생산 시스템",
        "FULT": "펜실베이니아 지역 상업은행",
        "FWRD": "항공·트럭 화물 운송",
        "GAIN": "글래드스톤 BDC · 중소기업 대출",
        "GAMB": "스포츠 베팅 비교·정보 플랫폼",
        "GATX": "철도 화차 리스 · 항공기 엔진",
        "GBCI": "몬타나 기반 지역 상업은행",
        "GBDC": "골럽 BDC · 선순위 담보 대출",
        "GDOT": "선불카드 · 디지털 뱅킹",
        "GDRX": "처방약 할인 쿠폰 플랫폼",
        "GDS": "중국 데이터센터 임대·운영",
        "GEF": "산업용 강철·섬유 드럼 패키징",
        "GENI": "스포츠 데이터·AI 분석 · 베팅 피드",
        "GERN": "골수이형성증후군 텔로머라제 억제제",
        "GEVO": "재생 가능 항공 연료·이소부탄올",
        "GIII": "DKNY·KARL LAGERFELD 패션",
        "GILT": "이스라엘 위성통신 · 군용 네트워크",
        "GKOS": "녹내장 미세수술 임플란트",
        "GLAD": "글래드스톤 캐피탈 BDC",
        "GLATF": "나미비아 우라늄 탐사·개발",
        "GMED": "척추 임플란트 · 정형외과 로봇",
        "GNE": "소규모 전력 소매 · 에너지 서비스",
        "GNENF": "중국 리튬 정제 · 배터리 소재",
        "GNTX": "자동조광 미러 · 카메라 모듈",
        "GO": "창고형 할인 식료품 소매",
        "GOGO": "항공기 기내 와이파이 통신",
        "GOOGL": "알파벳 검색·유튜브·클라우드",
        "GOOS": "캐나다 구스 프리미엄 패딩",
        "GRBK": "텍사스·조지아 신규 주택 건설",
        "GT": "굿이어 타이어 · 글로벌 유통",
        "GTY": "주유소 부동산 넷리스 리츠",
        "GWRE": "보험사용 IT 플랫폼 SaaS",
        "GXO": "3PL 계약 물류 · 창고 자동화",
        "HAE": "혈액 관리·자가혈 수집 의료기기",
        "HAIN": "유기농·자연식품 브랜드",
        "HALO": "항체-약물 결합체 ENHANZE 기술",
        "HAYW": "수영장 장비 · 히트펌프",
        "HCC": "야금용 고급 점결탄 채굴",
        "HCM": "허치메드 항암제 · 중국 바이오",
        "HE": "하와이 전력 유틸리티",
        "HEI-A": "항공우주 FAA 부품 · MRO",
        "HESM": "헤스 가스 집하·처리 MLP",
        "HGV": "힐튼 그랜드 베케이션 타임쉐어",
        "HIW": "선벨트 오피스 리츠",
        "HOG": "할리데이비슨 모터사이클",
        "HOMB": "아칸소 기반 지역 상업은행",
        "HOV": "미국 동부·서부 주택 건설",
        ...
        "HR": "의료 오피스 빌딩 리츠",
        "HRMY": "수면 장애·뇌질환 신약",
        "HTGC": "벤처 BDC · 테크 스타트업 대출",
        "HTLD": "미국 트럭 운송 · 냉동 화물",
        "HUBG": "트럭·철도 복합 운송 3PL",
        "HUYA": "중국 게임 스트리밍 플랫폼",
        "HWC": "걸프코스트 지역 상업은행",
        "HXL": "탄소 복합재 · 항공우주 구조물",
        "IAG": "캐나다·아프리카 금 채굴",
        "IART": "신경외과·정형외과 재생의학",
        "IBOC": "텍사스 히스패닉계 지역 은행",
        "IBP": "단열재 설치 · 건설 서비스",
        "ICUI": "정맥주사·수혈 의료 소모품",
        "IDA": "아이다호 전력 유틸리티",
        "IEX": "유체 제어 장비 · 산업용 펌프",
        "IIPR": "대마초 시설 산업용 리츠",
        "IMXI": "미국-멕시코 송금 서비스",
        "INDB": "매사추세츠 지역 독립 상업은행",
        "INFQ": "광자 기반 양자컴퓨터",
        "INGR": "옥수수 전분·스테비아 식품소재",
        "INMD": "최소침습 미용·성형 RF 기기",
        "INSP": "수면무호흡 신경자극 임플란트",
        "INTA": "지출 관리·조달 SaaS",
        "INVA": "HIV 협업 라이선스 로열티",
        "IOSP": "연료·윤활유 특수 첨가제",
        "IOVA": "종양침윤 림프구 세포치료제",
        "IPAR": "향수 라이선스 · 럭셔리 브랜드",
        "IPGP": "광섬유 레이저 · 산업·의료 가공",
        "IQ": "아이치이 중국 스트리밍",
        "IRDM": "저궤도 위성 글로벌 통신",
        "IRT": "선벨트 아파트 리츠",
        "ITE": "채권 만기 분산 ETF",
        "JACK": "잭인더박스 패스트푸드",
        "JBGS": "워싱턴DC 복합 부동산 리츠",
        "JJSF": "소프트 프레즐·스낵 식품",
        "JKS": "중국 태양광 모듈 제조",
        "KAI": "산업용 정밀 공기 정화·여과",
        "KALU": "항공우주용 알루미늄 판재",
        ...
        "KOP": "석유 가스 화학 파이프 코팅",
        "KRG": "오픈에어 쇼핑센터 리츠",
        "KRUS": "컨베이어 벨트 스시 레스토랑",
        "KTB": "콘투어 스포츠·워크웨어",
        "KVYO": "이커머스 이메일 마케팅 자동화",
        "KWR": "금속 가공·자동차 공정 화학",
        "LAND": "미국 농지 리츠",
        "LBRDA": "차터 커뮤니케이션스 지분 보유",
        "LBRT": "유정 수압파쇄 서비스",
        "LCII": "RV·주택용 부품 제조",
        "LCNB": "오하이오 지역 커뮤니티 은행",
        "LEGH": "공장식 조립 주택 건설",
        "LEVI": "리바이 청바지 · 글로벌 데님",
        "LGIH": "엔트리급 신규 주택 건설",
        "LII": "레녹스 HVAC · 공조 시스템",
        "LILA": "중남미 케이블·통신 서비스",
        "LILAK": "리버티 라틴아메리카 추적주",
        "LIVN": "신경조절 임플란트 · 심장 판막",
        "LKNCY": "중국 커피 체인 · 라떼",
        "LMND": "AI 기반 디지털 보험",
        "LMNR": "캘리포니아 레몬·아보카도 농업",
        "LOCO": "엘 폴로 로코 멕시칸 치킨",
        "LPSN": "대화형 AI 고객서비스 플랫폼",
        "LTC": "고령자 요양시설 헬스케어 리츠",
        "LUMN": "기업 광섬유 네트워크 · AI 연결",
        "LW": "냉동 감자튀김 · 오레이다",
        "LXP": "단일 임차인 산업·물류 리츠",
        "MAC": "미국 쇼핑몰 리츠",
        "MAIN": "중소기업 BDC · 직접 투자",
        "MANH": "공급망 WMS·TMS 소프트웨어",
        "MAPS": "대마초 소매 데이터·소프트웨어",
        "MASI": "혈중산소 측정 · 환자 모니터링",
        "MATX": "하와이·알래스카 컨테이너 해운",
        "MAXN": "고효율 태양광 패널 제조",
        "MCD": "맥도날드 글로벌 패스트푸드",
        "MD": "소아과·가정의학 의원 운영",
        "MDRX": "의료 수익 사이클 관리 SaaS",
        "MDU": "유틸리티·건설자재 복합",
        "MEOH": "천연가스 기반 메탄올 제조",
        "MGNX": "이중특이성 항체 항암 신약",
        "MGRC": "장비 리스·렌탈 서비스",
        "MGY": "퍼미안 분지 석유 E&P",
        "MIDD": "상업용 주방 장비 · 식품 설비",
        "MIRM": "담즙산 간질환 신약",
        "MKTX": "기관 채권 전자거래 플랫폼",
        "MMSI": "최소침습 중재시술 의료기기",
        "MMYT": "인도 온라인 여행 플랫폼",
        "MOG-A": "항공우주·방산 정밀 모션 제어",
        "MOMO": "중국 라이브 스트리밍·소셜",
        "MQ": "카드발급 처리 · 임베디드 금융",
        "MRTN": "냉장 온도 트럭 운송",
        "MSA": "가스 감지·안전 장비",
        ...
        "NAVI": "학자금 대출 서비스·정산",
        "NBTB": "뉴욕 지역 커뮤니티 은행",
        "NCNO": "은행용 클라우드 대출 플랫폼",
        "NDLS": "누들스앤컴퍼니 패스트캐주얼",
        "NEE": "넥스트에라 태양광·풍력 1위",
        "NEOG": "식품·환경 병원체 검사 키트",
        "NEU": "연료·윤활유 첨가제 화학",
        "NHI": "고령자 주거·의료 헬스케어 리츠",
        "NMFC": "뉴마운틴 BDC · 중견기업 대출",
        "NOG": "비운영 소수 지분 석유 E&P",
        "NOV": "유전 굴착 장비·솔루션",
        "NOVT": "의료·산업 정밀 모션 제어",
        "NSA": "선벨트 자가 창고 리츠",
        "NSIT": "IT 제품 유통·관리 서비스",
        "NUVB": "항암 ADC · 임상 단계 바이오",
        "NWBI": "태평양 북서부 지역 은행",
        "NWE": "몬태나 전력·가스 유틸리티",
        "NWN": "오리건 천연가스 배급 유틸리티",
        "NXRT": "선벨트 아파트 리츠",
        "OBDC": "블루 아울 BDC · 선순위 대출",
        "OEC": "카본블랙 특수화학",
        "OFIX": "척추·관절 정형 임플란트",
        "OGE": "오클라호마 전력 유틸리티",
        "OGN": "여성건강·피부과 오리지널 의약품",
        "OGS": "오클라호마·캔자스 가스 배급",
        "OLED": "유기발광 OLED 소재 라이선스",
        "ONB": "인디애나 지역 상업은행",
        "ONDS": "철도 IoT·드론 자율비행 솔루션",
        "OOMA": "중소기업 VoIP·클라우드 통신",
        "OPCH": "가정 주사·영양 의료 서비스",
        "ORI": "손해·생명 보험 복합",
        "OSIS": "보안 검색 장비 · 검사 시스템",
        "OTTR": "노스다코타 전력·제조 복합",
        "OVV": "캐나다 오일샌드·미국 셰일 E&P",
        "OXM": "릴리풀리처·Tommy Hilfiger 라이선스",
        "OZK": "아칸소 기반 상업은행 · 부동산 대출",
        "PAHC": "반추동물 항생제·동물건강",
        "PATK": "RV·해양·주택 부품 제조",
        "PAY": "결제 중개 SaaS · 옴니채널",
        "PAYC": "HR 올인원 SaaS · 급여 처리",
        "PAYO": "중소기업 글로벌 결제 플랫폼",
        "PCRX": "수술 후 통증 서방형 진통제",
        "PDM": "선벨트 오피스 리츠",
        "PERI": "디지털 광고 수익화 플랫폼",
        "PI": "RFID 칩 · 산업용 IoT 센서",
        "PLAY": "데이브앤버스터스 엔터 레스토랑",
        "PLMR": "캘리포니아 특수 손해보험",
        "PNTG": "고령자 재활·요양 운영",
        "POR": "오리건 전력 유틸리티",
        "POST": "시리얼·스낵 브랜드 식품",
        "PRA": "의사 전문직 배상 보험",
        "PRCT": "전립선 절제 로봇 수술 시스템",
        "PRGO": "OTC 일반의약품 제조",
        "PRGS": "엔터프라이즈 소프트웨어 개발·보안",
        "PRPL": "젤 폼 매트리스",
        "PSEC": "프로스펙트 BDC · 중소기업 대출",
        "PSFE": "온라인 결제 · 지갑 솔루션",
        "PTCT": "뒤센 근이영양증 RNA 치료제",
        "PTEN": "육상 시추 계약·완결 서비스",
        "PUMP": "유정 수압파쇄 펌핑 서비스",
        "PWR": "전력·통신 인프라 건설 EPC",
        "PZZA": "파파존스 피자 프랜차이즈",
        "QDEL": "독감·코로나 신속 진단 키트",
        "QFIN": "중국 온라인 소비자 금융",
        "RARE": "리소솜 축적 희귀질환 신약",
        "RBC": "항공우주·방산 정밀 베어링",
        "RCKT": "희귀 혈액·간질환 유전자 치료",
        "RELY": "크로스보더 B2B 글로벌 결제",
        "RES": "오일필드 서비스 · 코일튜빙",
        "REYN": "레이놀즈 랩·HEFTY 생활용품",
        "RGEN": "바이오의약품 정제·여과 소모품",
        "RHI": "회계·재무 전문직 인력 파견",
        "RLI": "특수 재산·상해 니치 보험",
        "RLX": "중국 전자담배 브랜드",
        "ROCK": "지붕·외장 건축자재",
        "ROOT": "AI 자동차 보험 · 텔레매틱스",
        "RPAY": "B2B 결제 자동화 AP 솔루션",
        "RSI": "러시 스트리트 온라인 카지노",
        "RVLV": "럭셔리 온라인 패션 플랫폼",
        "RXO": "화물 중개 디지털 플랫폼",
        "RYAM": "셀룰로스 특수 섬유 소재",
        "SA": "멕시코 귀금속 스트리밍",
        "SAIL": "아이덴티티 거버넌스 보안",
        "SAR": "사라토가 BDC · 중소기업 대출",
        "SBCF": "플로리다 지역 상업은행",
        "SBRA": "고령자 요양시설 헬스케어 리츠",
        "SBSI": "텍사스 지역 상업은행",
        "SCL": "특수 계면활성제·계면 화학",
        "SDGR": "슈뢰딩거 AI 신약 설계 플랫폼",
        "SFM": "스프라우츠 자연식품 슈퍼마켓",
        "SFNC": "아칸소 지역 상업은행",
        "SGRY": "외래 수술센터 운영",
        "SHC": "의료 멸균·방사선 처리 서비스",
        "SHLS": "태양광 균형 시스템·배선",
        "SID": "브라질 최대 일관제철소",
        "SIGI": "중소기업 특화 손해보험",
        "SITE": "조경·원예 자재 유통",
        "SKT": "아울렛 쇼핑몰 리츠",
        "SLG": "맨해튼 오피스 리츠",
        "SLGN": "알루미늄·플라스틱 식품 캔 패키징",
        "SLM": "개인 학자금 대출·절약",
        "SMP": "자동차 온도·제어 OEM 부품",
        "SMPL": "퀘스트 단백질바 · 건강 스낵",
        "SMWB": "웹·앱 디지털 인텔리전스 SaaS",
        "SNBR": "스마트 번호 조절 에어 매트리스",
        "SNDR": "미국 트럭·인터모달 운송",
        "SOHU": "중국 인터넷 미디어·검색",
        "SPB": "스펙트럼 홈케어·원예 브랜드",
        "SPWR": "주거용 태양광 패널 시스템",
        "SPXC": "HVAC 부품·산업용 시스템",
        "SR": "미주리 천연가스 배급 유틸리티",
        "SRAD": "스포츠 라이브 데이터·AI 분석",
        "SSB": "사우스스테이트 지역 상업은행",
        "SSD": "금속 연결재·건축 구조용 부품",
        "SSRM": "캐나다·터키 금·은 채굴",
        "STBA": "펜실베이니아 지역 상업은행",
        "STC": "부동산 소유권 보험·에스크로",
        "STEP": "세컨더리 사모펀드 운용",
        "SUPN": "뇌전증·CNS 신약",
        "SWX": "애리조나 천연가스 배급 유틸리티",
        "SXI": "산업용 전자·유압 복합 부품",
        "SYNA": "PC·모바일 터치·디스플레이 IC",
        "TACO": "델 타코 멕시칸 패스트푸드",
        "TALO": "멕시코만 심해 석유 E&P",
        "TASK": "AI 훈련 데이터·콘텐츠 운영 BPO",
        "TBLA": "네이티브 광고·콘텐츠 추천 플랫폼",
        "TCBI": "텍사스 기업 상업은행",
        "TDOC": "원격진료·정신건강 디지털 헬스",
        "TDW": "심해 유전 지원 선박 서비스",
        "TGTX": "TG101 혈액암 TYK2 억제제",
        "THG": "재산·상해 특화 보험",
        "THRM": "자동차 온열·냉각 시트 시스템",
        "TIGR": "중국인 대상 미국 주식 브로커",
        "TKR": "산업용 베어링·동력전달 부품",
        "TMHC": "미국 중대형 단독주택 건설",
        "TMP": "뉴욕 지역 커뮤니티 은행",
        "TNDM": "웨어러블 인슐린 펌프",
        ...
        "TPVG": "벤처 부채 BDC",
        "TREX": "합성 목재 데크·난간",
        "TRIP": "트립어드바이저 여행 리뷰·예약",
        "TRMK": "미시시피 지역 상업은행",
        "TRN": "철도 화차 제조·리스",
        "TRNO": "도심 물류 산업용 리츠",
        "TRS": "엔지니어드 금속·플라스틱 패키징",
        "TRU": "소비자 신용정보·사기방지",
        "TTEC": "AI 고객경험 BPO",
        "TUYA": "중국 IoT 스마트홈 플랫폼",
        "TVTX": "IgA 신병증 신약",
        "TWO": "에이전시 모기지 리츠",
        "TX": "멕시코 일관제철 · 철강",
        "UBSI": "웨스트버지니아 지역 상업은행",
        "UE": "뉴저지 오픈에어 리테일 리츠",
        "UFPI": "목재 팰릿·건축용 목재 가공",
        "UFPT": "의료·산업용 발포·복합재 패키징",
        "UMBF": "캔자스 지역 은행·자산운용",
        "UNFI": "유기농·자연식품 도매 유통",
        "UNIT": "광섬유 네트워크 통신 리츠",
        "USAC": "미드스트림 가스 압축 MLP",
        "USFD": "미국 2위 식자재 유통",
        "USLM": "텍사스 석회석·석회 채굴",
        "USPH": "외래 물리치료 클리닉 운영",
        "UTL": "뉴잉글랜드 전력·가스 유틸리티",
        "VAC": "메리어트 타임쉐어·베케이션",
        "VCYT": "갑상선 분자 진단 검사",
        "VIRT": "전자 마켓메이킹 · 고빈도 거래",
        "VITL": "패스처레이즈드 계란·버터",
        "VLY": "뉴저지 지역 상업은행",
        "VMI": "농업용 관개 장비·인프라",
        "VNET": "중국 중립 데이터센터 호스팅",
        "VRDN": "안구 희귀질환 신약",
        "VRRM": "통행료·주차 ETC 솔루션",
        "VSCO": "빅토리아 시크릿 란제리",
        "VSEC": "항공우주·방산 MRO 서비스",
        "VSH": "저항기·커패시터 수동 부품",
        "VTEX": "라틴아메리카 이커머스 SaaS 플랫폼",
        "WABC": "북캘리포니아 지역 상업은행",
        "WAFD": "태평양 북서부 주택담보 대출 은행",
        "WATT": "무선 전력 전송 반도체 IP",
        "WBS": "코네티컷 지역 상업은행",
        "WDFC": "WD-40 방청·윤활 소비재",
        "WDH": "중국 온라인 의료보험 플랫폼",
        "WEN": "웬디스 패스트푸드 프랜차이즈",
        "WERN": "온도 관리 특수 트럭 운송",
        "WES": "록키산맥 가스 집하·처리 MLP",
        "WFCF": "Non-GMO·할랄 농식품 인증",
        "WFRD": "유정 시추액 관리·드릴링 서비스",
        "WH": "윈덤 호텔 프랜차이즈 글로벌",
        "WHD": "유정 완결 공구·생산 장비",
        "WIT": "인도 IT 아웃소싱·컨설팅",
        "WLK": "PVC·염소화학 통합 제조",
        ...
        "WSFS": "델라웨어 지역 상업은행",
        "WTI": "멕시코만 해상 석유 생산",
        "WTS": "수처리·HVAC 유량 제어 부품",
        "WTTR": "유전 용수 조달·처리 서비스",
        "WVVI": "오리건 와인 양조·직판",
        "XERS": "저혈당 응급 글루카곤 주사",
        "XNCR": "항체 엔지니어링 플랫폼 바이오",
        "XNDU": "광자 집적회로 양자컴퓨터",
        "XNET": "중국 온라인 성인교육 플랫폼",
        "XPEL": "자동차 페인트 보호 필름",
        "XPRO": "유정 화학·완결 서비스",
        "XYL": "자일렘 수처리·펌프 솔루션",
        "YELP": "지역 비즈니스 리뷰·검색",
        "YEXT": "브랜드 지식 그래프 AI SaaS",
        "YMM": "중국 화물 트럭 중개 플랫폼",
        "YUMC": "얌차이나 KFC·피자헛 중국",
        "ZETA": "마케팅 데이터 클라우드 플랫폼",
    }
    ...
    def _init_sector_data(self):
        ...
        self.us_sectors = {
            ...
            "🤖 AI & Mega Tech": {
                ...
                "AI Platform & Cloud":  ["ADBE","AI","AMZN","APPF","APPN","ASAN","BBAI","BL","BOX","BRZE","BSY","CARG","CRM","CWAN",
                                      "DDOG","DOCN","DOMO","DT","ESTC","FROG","FRSH","FSLY",
                                      "GOOGL","GRRR","GTLB","GWRE","HUBS","IBM","INTA","INTU",
                                      "KVYO","LPSN","MANH","MDB","MNDY","MSFT","NCNO","NOW",
                                      "NTNX","ORCL","PATH","PAYC","PLTR","RBRK","SMWB","SNOW",
                                      "SOUN","TEAM","TEM","WDAY","YEXT"],
                "AI Infrastructure":    ["AAOI","AMT","ANET","APLD","CLS","CLSK","CMBM","COHR","CORZ","CRDO","CRWV","CSCO","DELL","DLR",
                                      "EGHT","EQIX","GLW","HPE","IONQ","IREN","IRM","LITE",
                                      "LUMN","MTSI","NBIS","NTAP","PI","PSTG","QBTS","QUBT",
            ...
            # ── 2. AI 반도체 ─────────────────────────────────────────────────
            "🔬 AI Semiconductors": {
                "AI GPU & HBM Core":    ["ALAB","AMD","ARM","AVGO","INTC","KLAC","LRCX","MRVL","MU","NVDA","TSM"],
                "Fabless & Analog":     ["ACMR","ADI","ALGM","AMBA","AOSL","CRUS","DIOD","INDI","IPGP","LFUS","LSCC","MCHP","MPWR",
                                      "NXPI","OLED","ON","PI","POET","POWI","QCOM","QRVO",
                                      "RMBS","SITM","SLAB","SMTC","STM","SWKS","SYNA","TXN",
                                      "VSH","WOLF"],
            ...
            "💰 Finance & Fintech": {
                ...
                "Mega Banks & IB":      ["ABCB","ASB","AX","BAC","BANF","BANR","BK","BKU","BMO","BOH","BPOP","C","CATY","CBSH","CBU",
                                      ...
                                      "WSFS","WTFC","ZION"],
                "Alt Assets & PE":      ["AMG","APO","ARCC","ARES","BAM","BEN","BLK","BX","BXSL","CG","CSWC","FSK","GAIN","GBDC","GLAD",
                                      "HTGC","IVZ","KKR","LPLA","MAIN","NMFC","OBDC","OWL",
                                      "PSEC","RJF","SAR","STEP","TPVG","TROW","TWO"],
                "Insurance":            ["ACGL","AFG","AFL","AIG","AJG","ALL","AON","BRK-B","BRO","CB","CINF","EG","EQH","FAF",
            ...
            "🏭 Industrial & Defense": {
                ...
                "Industrials":          ["AAON","ACA","AGCO","AIT","ALLE","ALSN","AME","AMRC","AOS","APG","ASGN","B","BCPC","BLD",
                                      ...
                                      "FIX","FLR","FSS","FTV","GATX","GEV","GFL","GGG","GWW",
                                      "GXO","HEI","HEI-A","HON","IEX","IR","ITW","J","KAI",
                                      "KNX","LECO","LII","LKQ","MAS","MATX","MIDD","MMM","MOD",
                                      "MSA","MTZ","NDSN","NSIT","OSIS","OTIS","PCAR","PH","PNR",
                                      "POOL","QXO","RBC","ROK","ROP","RSG","SITE","SNA","SSD",
                                      "SWK","SXI","TKR","TREX","TRN","TT","TTC","UFPI","URI",
                                      "VMI","WAB","WCN","WM","WSC","WTS","XYL"],
            ...
            # ── 5. 에너지 ────────────────────────────────────────────────────
            "⚡ Energy": {
                "Oil & Gas Majors":     ["APA","AR","BKR","CHRD","COP","CRGY","CVX","DVN","EC","EOG","EQT","FANG",
                                      "MGY","MPC","MTDR","NOG","OVV","OXY","PBR",
                ...
                "Utilities":            ["AEE","AEP","AES","ATO","AVA","AWK","BEP","BKH","CLNE","CMS","CNP","CWT","D","DTE","DUK","ED",
                                      ...
                                      "NEE","NI","NRG","NWE","NWN","OGE","OGS","OTTR","PCG",
                                      "PEG","PNW","POR","PPL","SO","SR","SRE","SWX","UTL","WEC",
                                      "WTRG","XEL"],
                "Oil Services":         ["AROC","BOOM","CLB","DNOW","FTI","HAL","HP","LBRT","NOV","PTEN","PUMP","RES","TDW","WFRD",
                                      "WHD","WTTR","XPRO"]
            },

            # ── 6. 헬스케어 & 바이오 ─────────────────────────────────────────────
            "🧬 Healthcare & Biotech": {
                "Big Pharma":           ["ABBV","AMGN","AZN","BMY","CORT","CRL","ELAN","GILD","GSK","HCM","JAZZ","JNJ","LLY","MRK",
                                      "NBIX","NVO","NVS","OGN","PAHC","PCRX","PFE","PRGO",
                                      "REGN","SNY","SUPN","TAK","TEVA","VRTX","VTRS"],
                "GLP-1 & Obesity":      ["ALT","AMGN","CGON","GPCR","LLY","LNTH","NVO","PEPG","VKTX"],
                "ADC & Gene Therapy":   ["ACAD","ADMA","AGIO","ALKS","ALNY","ARVN","ARWR","AXSM","BBIO","BEAM","BHVN","BIIB","BMRN",
                                      "BNTX","CRNX","CRSP","DNA","EDIT","EXEL","GERN",
                                      "HALO","HRMY","ILMN","IMVT","INCY","INSM","IONS","IOVA",
                                      "KRYS","KYMR","LEGN","MDGL","MGNX","MIRM","MRNA","NTLA",
                                      "NUVB","PCVX","PTCT","RARE","RCKT","RCUS","RGEN","ROIV",
                                      "RVMD","RXRX","SMMT","TGTX","TVTX","UTHR","VRDN","XERS",
                                      "XNCR"],
                "Medical Devices":      ["A","ABT","ALGN","AVNS","BAX","BDX","BRKR","BSX","CAH","CDNA","DHR","DXCM","ESTA","EW",
                                      "GEHC","GKOS","GMED","HAE","HSIC","IART",
                                      "ICUI","IDXX","INMD","INSP","ISRG","LH","LIVN","MASI",
                                      "MDT","MMSI","MTD","NEOG","NOVT","NTRA","NVCR","OFIX",
                                      "PEN","PODD","PRCT","QDEL","RMD","RVTY","STE","SYK","TFX",
            ...
            # ── 7. 소비재 & 리테일 ──────────────────────────────────────────────
            "🛍️ Consumer & Retail": {
                "E-commerce & Travel":  ["ABNB","AMZN","BABA","BIDU","BKNG","CARG","CART","CHWY","CPNG","CPRT","DASH","EBAY","ETSY",
                                      "EXPE","FWRD","GRAB","JD","MELI","MMYT","MNSO","PDD",
                                      "RVLV","SE","SHOP","TCOM","TRIP","VTEX","W","YELP"],
                "Retail Giants":        ["ACI","AEO","ANF","BBWI","BBY","BJ","BOOT","BURL","CASY","COST","DBI","DECK","DG","DKS","DLTR",
                                      "FIVE","FND","GME","GO","GOOS","HD","KR","KSS",
                                      "KTB","LEVI","LOW","OLLI","PRPL","RH","ROST","SFM","SMPL",
                                      "TGT","TJX","TSCO","URBN","VSCO","WMT","WOOF","WSM"],
                "Restaurants":          ["ARCO","BJRI","BROS","CAKE","CAVA","CMG","DIN","DNUT","DPZ","DRI","EAT","JACK","KRUS","LOCO",
                ...
                "Luxury & Apparel":     ["BIRK","CPRI","CROX","DECK","EL","ELF","FIGS","GIII","GIL","GOOS","LEVI","LULU","MOV","NKE",
                                      "ONON","OXM","PTON","PVH","RL","SNBR","TPR",
                                      "ULTA","VFC","WFCF","WOOF"],
                "Hotels & Gaming":      ["BYD","CCL","CHDN","CZR","GENI","GLPI","H","HGV","HLT","LVS","MAR","MGM","MMYT","NCLH","PENN",
                                      "RCL","RSI","TNL","VAC","WH","WYNN"],
                "China & EM ADRs":      ["ATHM","BABA","BEKE","BIDU","BILI","DIDIY","EDU","FUTU","GDS","HCM","HTHT","HUYA","IQ","JD",
                                      "KC","LI","LKNCY","MNSO","MOMO","NIO","PDD","QFIN","RLX",
                                      "SOHU","TAL","TCOM","TIGR","TME","TUYA","VNET","WB","WDH",
                                      "XNET","XPEV","YMM","YUMC","ZTO"]
            },

            # ── 8. 소비자 필수재 & 식음료 ──────────────────────────────────────────
            "🥤 Consumer Staples": {
                "Beverages & Spirits":  ["BF-B","BUD","CCEP","CELH","COKE","DEO","DSGX","FIZZ","KDP","KO","MNST","PEP","SAM","STZ",
                                      "TAP","WVVI"],
                "Food & Household":     ["BYND","CAG","CALM","CENTA","CHD","CHEF","CL","CLX","CPB","DAR","EPC","FRPT","GIS","GO","HAIN",
                                      "HSY","INGR","IPAR","JJSF","KHC","KMB","KVUE","LW",
            ...
            # ── 9. 미디어 & 엔터테인먼트 ───────────────────────────────────────────
            "🎮 Media & Entertainment": {
                "Social & Ad Tech":     ["ANGI","APGE","BMBL","CARG","CRTO","DJT","DV","GENI","GOOGL","IAC","MAPS","META","MGNI",
                                      "MTCH","PERI","PINS","PUBM","RDDT","RUM","SNAP","TBLA",
                                      "TTD","YELP","ZD","ZETA"],
                "Gaming":               ["AGYS","BETZ","CHDN","DKNG","EA","FLUT","GAMB","GENI","GLPI","MSFT","NTES","PLTK","RBLX","RSI",
                                      "SRAD","TCEHY","TTWO","U"],
                "Streaming & Content":  ["AMC","BATRA","BATRK","CHTR","CNK","COUR","DIS","FOX","FOXA","FUBO","IMAX","LILA","LILAK",
                                      "LYV","MSGE","MSGS","NFLX","NWSA","ROKU","SIRI",
                                      "SONY","SPOT","TKO","WBD"]
            },
            ...
            "🏠 Real Estate": {
                ...
                "Residential REITs":    ["AMH","APLE","AVB","BRT","CPT","CSR","ELME","ELS","EQR","ESS","INVH","IRT","MAA","NHI","NXRT",
                                      "SUI","UDR"],
                "Retail & Office":      ["ADC","ARE","BRX","BXP","CTRE","CUZ","DEI","EPRT","FCPT","FRT","HIW","HST","JBGS","KIM","KRC",
                                      "KRG","LAMR","LXP","MAC","NNN","O","PDM","REG","SKT",
                                      "SPG","UE","VICI","VNO","WPC"],
                "Healthcare REITs":     ["CHCT","CTRE","DOC","HR","LTC","NHI","OHI","SBRA","VTR","WELL"],
                "Homebuilders":         ["BZH","CCS","CVCO","DFH","DHI","GRBK","HOV","KBH","LEGH","LEN","LGIH","MHO","MTH","NVR","OPEN",
                                      "PHM","RKT","SKY","TMHC","TOL","UWM"]
            },

            # ── 11. 소재 & 원자재 ──────────────────────────────────────────────
            "🧪 Materials & Commodities": {
                "Chemicals":            ["ALB","APD","ASH","AVNT","AXTA","BCPC","CBT","CC","CE","CRH","DD","DOW","ECL","ECVT","EMN",
                                      "FUL","GEVO","HUN","IFF","IOSP","KOP","KWR","LIN","LYB",
                                      "MEOH","NEU","OEC","OLN","PPG","RPM","RYAM","SCL","SHW",
                                      "TROX","WDFC","WLK"],
                "Construction Materials":["BLDR","EXP","IBP","ITE","MLM","ROCK","USLM","VMC"],
                "Packaging":            ["AMBP","ATR","BALL","CCK","GEF","IP","PKG","REYN","SLGN","SON","TRS","UFPT"],
                "Metals & Mining":      ["AA","AMR","ATI","BTU","CDE","CENX","CLF","CMC","CMP","CRS","CSTM","EAF","FCX","HCC","KALU",
                                      "MGRC","MP","NUE","RS","SCCO","SID","STLD","TECK","TX",
                                      "USAC","VALE","WOR"],
                "Gold & Precious":      ["AEM","AG","AU","BTG","CDE","DRD","EGO","FNV","GFI","GOLD","HL","IAG","KGC","NEM","OR","PAAS",
                                      "RGLD","SA","SSRM","WPM"],
                "Lithium & Battery":    ["ALB","BATT","ENVX","GNENF","LAC","MVST","QS","SES","SLDP","SQM"]
            },

            # ── 12. 통신 & 5G ───────────────────────────────────────────────
            "📡 Telecom & 5G": {
                "Telecom Giants":       ["BCE","CCOI","CHTR","CMCSA","GOGO","LBRDA","LBRDK","SHEN","T","TMUS","TU","VZ"],
                "5G & Satellite":       ["ASTS","CALX","CIEN","CLFD","CSCO","DGII","EXTR","GILT","GSAT","IRDM","MSI","NOK",
                                      "OOMA","QCOM","SATS","SPOK","VIAV","VSAT"]
            },

            # ── 13. 비즈니스 서비스 & 데이터 ────────────────────────────────────────
            "💼 Business & Data Services": {
                "HR & Payroll":         ["ADP","ASGN","KELYA","KFY","MAN","PAYC","PAYX","PCTY","RHI","WK"],
                "Consulting & IT Svc":  ["ACN","ASGN","BAH","CACI","CDW","DXC","INFY","LDOS","NSIT","SAIC","TASK","TTEC","WIT"],
                "Data & Analytics":     ["CWAN","EFX","EXLS","FDS","MCO","SPGI","TRI","TRU","VRSK"],
                "Business Process":     ["BR","CBRE","CSGP","DSP","EVTC","FIS","FISV","FLUT","GPN","NAVI","PAY","SLM","VRRM","WEX"]
            }
        }
        ...
        self.kr_sectors = {
            '🔬 반도체': {
                ...
                '반도체장비·소재': ['005290.KQ', '014680.KS', '322310.KQ', '036540.KQ', '036810.KQ', '036930.KQ', '178920.KS', '281820.KS', '357780.KQ', '403870.KQ', '240810.KQ', '272290.KQ', '058470.KQ', '104830.KQ', '140860.KQ', '108320.KS', '095340.KQ', '064760.KQ', '039030.KQ', '417840.KQ', '098460.KQ', '095610.KQ', '084370.KQ', '112290.KQ', '064290.KQ', '053610.KQ', '089890.KQ', '089970.KQ', '122640.KQ', '348210.KQ', '101490.KQ', '131970.KQ', '457370.KQ', '054620.KQ', '083450.KQ', '030530.KQ', '327260.KQ', '170920.KQ', '059090.KQ', '178930.KQ'],
            ...
            '⚡ 전력 인프라': {
                ...
                '원전·SMR': ['015760.KS', '034020.KS', '051600.KS', '052690.KS', '083650.KQ', '105840.KS', '032820.KQ', '103590.KS', '271940.KS', '267260.KS', '036460.KS', '272210.KS', '475150.KS', '382900.KQ', '336260.KS', '298040.KS', '010120.KS', '028050.KS', '000720.KS', '000150.KS', '009770.KS'],
            ...
            '🛡️ K-방산': {
                '방산 대형주': ['000880.KS', '012450.KS', '047810.KS', '064350.KS', '064960.KS', '079550.KS', '272210.KS', '103140.KS', '005810.KS', '005870.KS', '003570.KS', '489790.KS', '010820.KS', '065450.KQ', '125490.KQ', '437730.KQ', '099320.KQ'],
                '방산 부품·전자전': ['005810.KS', '005870.KS', '010820.KS', '065450.KQ', '103140.KS', '272210.KS', '099320.KQ', '274090.KQ', '321370.KQ', '437730.KQ', '489790.KS', '125490.KQ', '010170.KQ', '214430.KQ', '082920.KQ', '211270.KQ', '189300.KQ', '474170.KQ', '047810.KS', '003570.KS', '064960.KS'],
                '드론·우주': ['047810.KS', '099320.KQ', '274090.KQ', '321370.KQ', '377330.KQ', '437730.KQ', '211270.KQ', '189300.KQ', '474170.KQ', '064350.KS', '272210.KS', '012450.KS', '079550.KS', '489790.KS', '214430.KQ', '003490.KS', '010170.KQ', '082920.KQ', '010820.KS', '065450.KQ', '125490.KQ', '005870.KS'],
            },
            '⚓ 조선·해운': {
            ...
            '🔋 이차전지·ESS': {
                '배터리 셀': ['006400.KS', '096770.KS', '247540.KQ', '373220.KS', '086520.KQ', '450080.KS', '383310.KQ', '003670.KS', '005070.KS', '361610.KS', '066970.KS', '051910.KS', '065350.KQ', '336370.KS', '278280.KQ', '093370.KS', '348370.KQ', '020150.KS', '014680.KS', '457190.KS', '078600.KQ'],
            ...
            '🧬 바이오·헬스케어': {
                ...
                '비만치료제·GLP-1': ['000100.KS', '069620.KS', '087010.KQ', '095700.KQ', '128940.KS', '214370.KQ', '068270.KS', '326030.KS', '170900.KS', '249420.KS', '009290.KS', '003850.KS', '009420.KS', '185750.KS', '006280.KS', '000250.KQ', '397030.KQ', '207940.KS', '008930.KS', '068760.KQ', '196170.KQ'],
                '의료기기·디지털헬스': ['039840.KQ', '041830.KQ', '145020.KQ', '145720.KS', '214150.KQ', '137310.KS', '064550.KQ', '086900.KQ', '099190.KQ', '328130.KQ', '338220.KQ', '043150.KQ', '214450.KQ', '207940.KS', '028300.KQ', '140860.KQ', '108860.KQ', '336570.KQ', '424980.KQ', '253840.KQ', '127120.KQ'],
            },
            '🦾 로봇·자동화': {
            ...
            '💰 금융·밸류업': {
                ...
                '증권·자산운용': ['001500.KS', '003540.KS', '005940.KS', '006800.KS', '016360.KS', '039490.KS', '001720.KS', '030210.KS', '003530.KS', '030610.KS', '088980.KS', '071050.KS', '100790.KQ', '027360.KQ', '138040.KS', '316140.KS', '105560.KS', '055550.KS', '086790.KS', '138930.KS', '030190.KS'],
                ...
                '핀테크·금융데이터': ['064850.KQ', '053580.KQ', '035600.KQ', '060250.KQ', '115500.KQ', '030190.KS', '377300.KS', '323410.KS', '052400.KQ'],
            },
            '🎮 콘텐츠·엔터': {
                'K-엔터·IP': ['035760.KQ', '035900.KQ', '041510.KQ', '122870.KQ', '253450.KQ', '352820.KS', '376300.KQ', '225570.KQ', '067160.KQ', '373200.KQ', '462870.KS', '263750.KQ', '251270.KS', '259960.KS', '035720.KS', '035420.KS', '293490.KQ', '078340.KQ', '095660.KQ', '069080.KQ', '302920.KQ', '263720.KQ'],
            ...
            '🔮 양자컴퓨팅': {
                '양자보안·암호': ['456010.KQ'],
                '양자센서·하드웨어': ['456010.KQ', '140860.KQ'],
            },
            '🏗️ 건설·건자재': {
                '대형 건설': ['000210.KS', '000720.KS', '006360.KS', '028050.KS', '028260.KS', '047040.KS', '294870.KS', '375500.KS', '001230.KS', '017960.KS', '003070.KS', '004960.KS', '002990.KS', '009410.KS', '097230.KS', '012630.KS', '014790.KS', '042940.KQ', '035890.KQ', '000150.KS'],
                '건자재·시멘트': ['002380.KS', '003070.KS', '004980.KS', '010780.KS', '038500.KQ', '009240.KS', '462520.KS', '015020.KS', '300720.KS', '183190.KS', '090350.KS', '000390.KS', '108670.KS', '007210.KS', '025750.KS', '009450.KS'],
            },
            '⚙️ 철강·화학': {
                '철강·비철': ['001230.KS', '001430.KS', '002710.KS', '004020.KS', '005490.KS', '008350.KS', '010130.KS', '058430.KS', '004560.KS', '006110.KS', '354320.KQ', '103140.KS', '005810.KS', '017960.KS', '006340.KS', '120030.KS', '021040.KQ', '009520.KQ'],
            ...
            '🚚 물류·유통': {
                ...
                '유통·이커머스': ['007070.KS', '015020.KS', '035080.KQ', '069960.KS', '139480.KS', '027410.KS', '023530.KS', '004170.KS', '282330.KS'],
            },
            '🌾 스마트팜·애그테크': {
                '스마트팜·농기계': ['000490.KS', '054050.KQ', '186230.KQ', '403490.KQ', '050860.KQ', '017810.KS', '002900.KS', '003380.KQ'],
            },
            '💊 디지털헬스·AI의료': {
                'AI의료영상·진단': ['099190.KQ', '214150.KQ', '328130.KQ', '338220.KQ', '041830.KQ', '039840.KQ', '053030.KQ', '214370.KQ', '041920.KQ', '424980.KQ', '389030.KQ', '024850.KQ', '043150.KQ', '145720.KS', '039200.KQ'],
                '헬스케어플랫폼·EMR': ['032620.KQ', '032850.KQ', '033230.KQ', '108860.KQ', '099190.KQ', '389030.KQ', '078160.KQ', '338220.KQ', '328130.KQ', '099750.KQ', '041920.KQ', '376900.KQ', '458870.KQ', '041830.KQ', '214450.KQ'],
            },
            '🏢 지주사·종합상사': {
                ...
                '종합상사·무역': ['047050.KS', '001120.KS', '001740.KS', '011760.KS', '004800.KS', '002320.KS', '000150.KS', '035250.KS', '267250.KS', '028260.KS', '180640.KS', '086280.KS', '111770.KS', '009970.KS', '298050.KS', '298020.KS', '298000.KS', '078930.KS', '034730.KS', '003550.KS', '004990.KS', '001040.KS'],
            },
            '⛽ 정유·에너지': {
                '정유': ['010950.KS', '096770.KS', '267250.KS', '011170.KS', '011780.KS', '006120.KS', '010060.KS', '006650.KS', '010130.KS', '298000.KS', '078930.KS', '456040.KS', '024060.KQ', '004000.KS', '120110.KS', '004090.KS', '069260.KS', '003830.KS', '005090.KS', '017940.KS'],
